...
public class PuzzleElement {
    ...
    ImageIcon puzz1 = new ImageIcon("images/1.png");
    ImageIcon puzz2 = new ImageIcon("images/2.png");
    ImageIcon puzz3 = new ImageIcon("images/3.png");
    ImageIcon puzz4 = new ImageIcon("images/4.png");
    ImageIcon puzz5 = new ImageIcon("images/5.png");
    ImageIcon puzz6 = new ImageIcon("images/6.png");
    ImageIcon puzz7 = new ImageIcon("images/7.png");
    ImageIcon puzz8 = new ImageIcon("images/8.png");
    ImageIcon puzz9 = new ImageIcon("images/9.png");
    ImageIcon puzz10 = new ImageIcon("images/10.png");
    ImageIcon puzz11 = new ImageIcon("images/11.png");
    ImageIcon puzz12 = new ImageIcon("images/12.png");
